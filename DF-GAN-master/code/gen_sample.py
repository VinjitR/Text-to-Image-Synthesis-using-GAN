...
def gen_exampler( output_dir, data_dic,netG,text_encoder):
        if cfg.TRAIN.NET_G == '':
            ...
            for key in data_dic:
                ...
                for i in range(1):  # 16
                    ...
                    for j in range(batch_size):
                        ...
                        fullpath = '%s_%3d.png' % (output_dir,i)
                        im.save(fullpath)



def gen_example_from_text(input_text, output_dir, wordtoix,netG,text_encoder):
    captions = []
    cap_lens = []
    data_dic = {}
    if len(input_text) == 0:
    ...
    gen_exampler(output_dir, data_dic,netG,text_encoder)
...
if __name__ == "__main__":
    ...
    if cfg.B_VALIDATION:
        if args.gen:
            print('Generating')
            gen_example_from_text(args.input_text,args.output_dir,dataset.wordtoix,netG,text_encoder)
